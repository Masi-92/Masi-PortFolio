!function(a){
    ...
    var c=function(a){
        ...
        this.velocity={x:(Math.random()-.5)*a.options.velocity,y:(Math.random()-.5)*a.options.velocity}
    };
    ...
    b.prototype.init=function(){
        if(this.k=document.createElement("div"),this.i.appendChild(this.k),
        ...
        window.addEventListener("resize",function(){
            ...
            !1:(this.canvas.width=this.i.size.width=this.i.offsetWidth,
